function mb_HandleSpecialSlashCommand(msg)
    ...
    elseif msg == "debugRequests" then
        ...
        for k, v in pairs(mb_queuedRequests) do
            mb_Print("    " .. v.type .. " by " .. v.from .. " with priority " .. v.priority .. " and body " .. tostring(v.body))
        end
        ...
        for k, v in pairs(mb_myPendingRequests) do
            mb_Print("    " .. v.type .. " with priority " .. v.priority .. " and body " .. tostring(v.body) .. ". Sent at " .. v.sentTime)
        end
    else
